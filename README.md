...
For the Preprocessing are tow methods are used. First the datatset get shuffeld increase the learning of the neuronal network and second the images are normalize to substitude the effect of the image brightness from the learning process. This boost the learning process.
...
<figure>
 <img src="./examples/learning_curve_learning_0.0005keep_prob0.7.jpg" width="850" alt="learning curve" />
 <figcaption>
 <p></p> 
